...
- [Yarning Circles](#yarning-circles)
  ...
  - [Front-end Implementation](#front-end-implementation)
    - [Wireframes](#wireframes)
      - [Home Page](#home-page)
      - [Login Page and Create Account Pages](#login-page-and-create-account-pages)
      - [Create a Course Page](#create-a-course-page)
...
![Create Account and Login Page](./img/Wireframe-login-create-account.png)

#### Create a Course Page
![Create Account and Login Page](./img/Wireframe-Create-Course.png)

#### Course Detail Page
![Create Account and Login Page](./img/Woreframe-Course-Page.png)

### Logo
![Transparent logo](./img/yarningcircles_logo_transparent.png)
![Logo](./img/Logo.png)
...
![colour palatte](./img/Colour-Palette.png)
